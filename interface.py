...
class Gui:
    ...
    def start(self):
        ...
        self.next_button = Button(self.video_tab, text="NEXT", command=self.go_next,fg="black", bg="white")
        self.prev_button = Button(self.video_tab, text="PREV", command=self.go_prev,fg="black", bg="white")
